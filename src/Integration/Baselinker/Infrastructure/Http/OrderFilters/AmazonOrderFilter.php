...
final class AmazonOrderFilter implements MarketplaceOrderFilterInterface
{
    public function supports(Marketplace $marketplace): bool
    {
        return $marketplace->code() === Marketplace::AMAZON;
    }

    public function buildParameters(FetchOrdersQuery $query): array
    {
        return array_filter([
            'filter_order_source' => Marketplace::AMAZON,
